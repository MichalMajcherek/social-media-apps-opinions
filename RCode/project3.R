...
setwd("/Users/michal/Politechnika/Projekt/OpinionMining3") #!!!!!!!!!!CHANGE!!!!!!!!!
wd<-"/Users/michal/Politechnika/Projekt/OpinionMining3"#!!!!!!!!!!CHANGE!!!!!!!!!
dir(wd)
...
Com<-read.csv("/Users/michal/Politechnika/Projekt/OpinionMining3/linkedin.csv", #!!!!!!!!!!CHANGE!!!!!!!!!
              header = TRUE,
              sep = "\t",
              strip.white = TRUE,
...
m <- as.matrix(dtm)
write.csv(m, file="/Users/michal/Politechnika/Projekt/excel2_ld/DocumentTermMatrix.csv") #!!!!!!!!!!CHANGE!!!!!!!!!
dtm
library(tm)
library(topicmodels)
library(lsa)
...
mycorpus_dataframe
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Topic1_comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
mycorpus_dataframe
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Topic2_comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
mycorpus_dataframe
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Topic3_comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
mycorpus_dataframe
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Topic4_comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
m11<-as.matrix(m1)
m11
write.csv(m11, file="/Users/michal/Politechnika/Projekt/excel2_ld/Sent_1.csv") #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Pos_Topic 1_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neg_Topic 1_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neu_Topic 1_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
m22<-as.matrix(m2)
m22
write.csv(m22, file="/Users/michal/Politechnika/Projekt/excel2_ld/Sent_2.csv") #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Pos_Topic 2_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neg_Topic 2_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neu_Topic 2_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
m33<-as.matrix(m3)
m33
write.csv(m33, file="/Users/michal/Politechnika/Projekt/excel2_ld/Sent_3.csv") #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Pos_Topic 3_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neg_Topic 3_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neu_Topic 3_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
m44<-as.matrix(m4)
m44
write.csv(m44, file="/Users/michal/Politechnika/Projekt/excel2_ld/Sent_4.csv") #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Pos_Topic 4_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neg_Topic 4_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
...
write.csv(mycorpus_dataframe,'/Users/michal/Politechnika/Projekt/excel2_ld/Neu_Topic 4_Comments.csv', row.names=FALSE) #!!!!!!!!!!CHANGE!!!!!!!!!
